   ...
   try:
    ...
    if message.startswith('~') and BOT_up == 1:
        ...
        if command.lower() == 'abc':
            if user in MODS:
                send_chat(irc, f'/me FeelsDankMan a...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan b...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan c...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan d...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan e...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan f...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan g...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan h...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan i...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan j...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan k...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan l...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan m...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan n...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan o...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan p...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan q...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan r...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan s...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan t...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan u...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan v...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan w...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan x...', channel)
                time.sleep(0.25)
                send_chat(irc, f'/me FeelsDankMan y...', channel)
                time.sleep(0.25)
