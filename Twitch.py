   ...
   try:
    ...
    if message.startswith('~') and BOT_up == 1:
        ...
        const_answers = {
            ...
            'help': 'List of all the commands FeelsDankMan 👉 https://github.com/nord-011/nords_BOT/main/README.md',
            'commands': 'List of all the commands FeelsDankMan 👉 https://github.com/nord-011/nords_BOT/main/README.md',
